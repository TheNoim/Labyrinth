...
public class Settings implements Screen, ApplicationListener, InputProcessor {
    ...
    private void draw() {
        ...
        font_text.draw(batch, "Musik", checkBoxPosX + (Gdx.graphics.getWidth() / 5), (checkBoxPos1Y + Gdx.graphics.getWidth() / 10) + Gdx.graphics.getWidth() / 20);
        font_text.draw(batch, "Sounds", checkBoxPosX + (Gdx.graphics.getWidth() / 5), (checkBoxPos2Y + Gdx.graphics.getWidth() / 10) + Gdx.graphics.getWidth() / 20);
        batch.end();
    }
